    ...
    return (
      <div className="login-screen">
        <form className="login-card" onSubmit={handleLogin}>
          ...
          <p style={{ fontSize: '0.7rem', marginTop: '1rem', color: '#888' }}>Acceso restringido a Dirección General. v0.1.4</p>
        </form>
      </div>
    );
  }
      ...
      <header>
        <div className="logo-container">
          ...
          <div className="db-indicator" title={`Estado DB: ${dbStatus}`}>
            ...
            <span className="db-text">{dbStatus === 'online' ? 'NUBE OK' : dbStatus === 'error' ? 'MODO LOCAL' : 'CONECTANDO...'} (v0.1.4)</span>
          </div>
        </div>
